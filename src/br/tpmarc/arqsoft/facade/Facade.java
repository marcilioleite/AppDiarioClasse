...
import br.tpmarc.arqsoft.validators.ChamadaValidator;
...
public class Facade {
	...
	public void salvarCurso(Curso curso) throws InvalidFieldException, RequiredFieldException {
	...
	public void salvarChamada(Chamada chamada) throws InvalidFieldException, RequiredFieldException {
		ChamadaValidator validator = new ChamadaValidator();
		validator.validate(chamada);
